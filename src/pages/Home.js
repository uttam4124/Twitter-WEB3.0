...
const Home = () => {
  ...
  async function maticTweet() {
    ...
    let options = {
      contractAddress: "0x5da1A6703a5Ef6fb708B844BAc4E87960b5f03d9",
  ...
  async function saveTweet() {
    ...
    newTweet.set("tweeterAcc", user.attributes.ethAdress);
    ...
    <>
      ...
      <div className="mainContent">
        <div className="profileTweet">
          <img
            src={useRef.attributes.pfp ? useRef.attributes.pfp : defaultImgs[0]}
          ></img>
